...
public class BaseClass {
	...
	public void setup(String br)
	{
		...
		logger = LogManager.getLogger(this.getClass());  // logging (this key word represents class and get class is use to catch the current class name)
		...
		driver.get(rb.getString("appURL"));    // get appurl from config.properties file
